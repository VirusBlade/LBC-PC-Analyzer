...
const CPU_SCORES: Record<string, { score: number; cpu_mark?: number; single_thread?: number; tier?: string; year?: number }> = {
  "Ryzen 7 H255": { score: 98, tier: "high", year: 2025 }, "Ryzen 7 9700X": { score: 91, tier: "high", year: 2024 }, "Ryzen 7 8745HS": { score: 98, tier: "high", year: 2024 }, "Ryzen 7 8700G": { score: 96, tier: "high", year: 2024 },
  ...
  "Intel i7-4790K": { score: 34, tier: "old", year: 2014 },
  "Intel i5-9500": { score: 52, tier: "old", year: 2019 }, "Intel i5-7500": { score: 45, tier: "old", year: 2017 }, "Intel i3-8109U": { score: 38, tier: "old_low_power", year: 2018 }, "Intel i5-8500T": { score: 43, tier: "old_low_power", year: 2018 },
...
const GPU_SCORES: Record<string, { score: number; tier: string }> = {
  ...
  "RTX 3060": { score: 58, tier: "mid" }, "GTX 1660 SUPER": { score: 38, tier: "entry" }, "GTX 1660": { score: 34, tier: "entry" }, "GTX 1650": { score: 24, tier: "old" }, "GTX 1060": { score: 22, tier: "old" }, "GTX 970": { score: 18, tier: "old" },
  "RX 7900 XTX": { score: 90, tier: "high" }, "RX 9070 XT": { score: 88, tier: "high" }, "RX 7800 XT": { score: 78, tier: "high" }, "RX 7700 XT": { score: 70, tier: "mid" }, "RX 7600": { score: 55, tier: "mid" },
...
const PENALIZED_CPUS = new Set(["Intel N100", "Intel N150", "Intel N4000", "Intel G630", "AMD A10", "Intel i7-4790K", "Intel i5-8500T", "Intel i5-6500T", "Intel i3-8109U", "Intel i3-7th gen"]);
